...
def data_extract(train_path,dev_path,test_path):
    train_data=[]
    dev_data=[]
    test_data=[]
    ...
    with open(dev_path) as data:
        for line in data:
            dev_data.append(line.strip().split())
...
dev_tok = data_extract(dev_file_sentence,dev_file_question,dev_file_answer)
...
test_tok = data_extract(test_file_sentence,test_file_question,test_file_answer)
